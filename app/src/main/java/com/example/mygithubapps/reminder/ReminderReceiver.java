...
import com.example.mygithubapps.Activity.MainActivity;
import com.example.mygithubapps.Activity.Reminder;
...
public class ReminderReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        title = "Aplication Github User";
        message = "Check your Aplication Now";
