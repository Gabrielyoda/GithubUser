...
public class ImageBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.example.mygithubapps.TOAST_ACTION";
    ...
    public static void updateWidget(Context context) {
        ...
        int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, ImageBannerWidget.class));
